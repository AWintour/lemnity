...
import { VideoWidgetEmbedRuntime } from './embedded/embedRuntime'

type FloatingPreviewProps = {
  onClose: () => void
}

const VideoWidgetFloatingPreview = ({ onClose }: FloatingPreviewProps) => {
  ...
  return createPortal(
    <div className='fixed inset-0 z-1200 bg-black/20 backdrop-blur-sm'>
      ...
      <VideoWidgetEmbedRuntime isPreview />
    </div>,
    document.body
  )
}

export default VideoWidgetFloatingPreview
