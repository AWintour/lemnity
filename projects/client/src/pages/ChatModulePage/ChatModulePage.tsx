...
// Кастомная иконка из svgexport-5 (5).svg (3-я кнопка тулбара форматирования).
const IconSvgExport5 = () => (
              ...
              <div className="rounded-[14px] bg-default-100 px-4 py-3">
                ...
                <div className="flex items-center gap-0.5 -mt-0.5 mb-1.5 text-[#6E6E76] border-b border-default-200/70 pb-1.5">
                  {([
                    ...
                    ['Зачёркнутый', () => applyWrap('~~'), <IconSvgExport5 key="s" />],
                ...
                <textarea
                  ...
                  // Enter — перенос строки; отправка только по кнопке «Отправить».
                  rows={2}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                title="Свернуть"
                className="w-9 h-9 shrink-0 flex items-center justify-center rounded-[8px] text-[#3D3D3B] hover:bg-default-100 hover:text-primary transition-colors"
              >
