...
// basically the same
// https://www.reactbits.dev/components/counter?value=610
...
function Digit({ place, value, height, digitStyle }: DigitProps) {
  // Numeric digit
  const valueRoundedToPlace = place === '.' || place === ','
    ? value
  ...
  return (
    ...
    >
      {/* Each digit is represented by 10 spans,
          one for each possible digit value (0-9) */}
