/**
 * Живой тест редактора «Обратный звонок» через РЕАЛЬНУЮ раскладку EditWidgetPage:
 * та же панель вкладок + FieldsSettingsTab (рендерит секции из реестра) + реальный WidgetPreview.
 * Визуал идентичен видеовиджету/анонсу, т.к. это те же самые компоненты редактора.
 * Запуск: http://localhost:5173/preview/callback.html
 */
...
const PREVIEW_ID = 'cb-preview'

// Чистим устаревший черновик прототипа (прежние версии хранили другую форму конфига под этим id),
