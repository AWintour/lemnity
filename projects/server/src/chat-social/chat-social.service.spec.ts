...
// admin.ts (imported transitively via ChatSubscriptionService) pulls WidgetType from the
// ESM-only @lemnity/database, which jest can't transform — stub the enum so the suite loads.
