...
console.log('Контент:', await p.getByText('Контент', {exact:true}).count(), '| Выравнивание:', await p.getByText('Выравнивание',{exact:true}).count(), '| Окно информации:', await p.getByText('Окно информации',{exact:true}).count());
